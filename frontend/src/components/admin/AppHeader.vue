<template>
  <header
    class="h-14 bg-white border-b border-gray-200 shadow-sm sticky top-0 z-50"
  >
    <div
      class="max-w-7xl mx-auto flex items-center justify-between px-4 lg:px-6 h-full"
    >
      ...
      <div class="relative flex items-center">
        <button
          @click="toggleEmail"
          class="flex items-center gap-1 p-1 rounded-full border border-blue-200 bg-blue-50 hover:bg-gray-100 transition lg:p-0 lg:border-0 lg:bg-transparent"
        >
