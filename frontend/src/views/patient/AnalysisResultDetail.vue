<template>
  <div class="min-h-[70vh] flex flex-col items-center p-4">
    <div
    ...
    <div
      ...
      class="text-center py-4 text-sm text-red-500"
    >
      ❌ {{ analysisStore.error }}
    </div>
    ...
    <div
      ...
      class="w-full max-w-6xl flex flex-col lg:flex-row gap-8 justify-center"
    >
      <div class="lg:w-1/3 flex justify-center items-center relative">
        <div
          class="w-full h-[520px] overflow-hidden rounded-2xl shadow-lg border border-gray-200 bg-white"
        >
          <iframe
          ...
          <div
            ...
            class="flex flex-col justify-center items-center h-full bg-gray-50 p-6"
          >
            <a
              :href="getFileUrl(analysisStore.result.file_url)"
              target="_blank"
              class="px-6 py-3 bg-blue-500 hover:bg-blue-600 text-white rounded-lg font-semibold shadow transition"
            >
              📄 PDFni ochish
            </a>
          </div>
        ...
        <a
          ...
          :href="getFileUrl(analysisStore.result.file_url)"
          download
          class="absolute top-2 right-2 bg-gray-400 text-white p-2 rounded-lg shadow hover:bg-gray-600 transition"
        >
          <DownloadIcon class="w-4 h-4" />
        </a>
      </div>

      <div class="lg:w-1/3 flex flex-col gap-4 justify-center">
        <h1 class="text-2xl font-bold text-primary text-center lg:text-left">
